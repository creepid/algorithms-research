...
public class EdgeWeightedDirectedCycle {
    ...
    private ResizedStack<DirectedEdge> cycle;    // directed cycle (or null if no such cycle)
    ...
    public EdgeWeightedDirectedCycle(EdgeWeightedDigraph G) {
        ...
        onStack = new boolean[G.vertexes()];
        edgeTo = new DirectedEdge[G.vertexes()];
    ...
    private void dfs(EdgeWeightedDigraph G, int v) {
        ...
        for (DirectedEdge e : G.adjacent(v)) {
            ...
            if (cycle != null) {
                ...
                cycle = new ResizedStack<DirectedEdge>();
                while (e.from() != w) {
                    cycle.push(e);
                    e = edgeTo[e.from()];
                }
