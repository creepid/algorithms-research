...
public final class DataInput {
     ...
     */
    public DataInput(java.net.Socket socket) {
        try {
    ...
    public static int[] readInts(String filename) {
        return new DataInput(filename).readAllInts();
    }
    ...
    public static double[] readDoubles(String filename) {
        return new DataInput(filename).readAllDoubles();
    }
    ...
    public static String[] readStrings(String filename) {
        return new DataInput(filename).readAllStrings();
    }
    ...
    public static int[] readInts() {
        return new DataInput().readAllInts();
    }
    ...
    public static double[] readDoubles() {
        return new DataInput().readAllDoubles();
    }
    ...
    public static String[] readStrings() {
        return new DataInput().readAllStrings();
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("---------------------------------------------------------------------------");
        try {
            in = new DataInput("../stdlib/InTest.txt");
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
            }
        ...
        System.out.println("---------------------------------------------------------------------------");
        in = new DataInput("/n/fs/introcs/www/java/stdlib/InTest.txt");
        try {
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
        ...
        System.out.println("---------------------------------------------------------------------------");
        try {
            in = new DataInput("G:\\www\\introcs\\stdlib\\InTest.txt");
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
            }
