 ...
 * @author rusakovich
 */
public class NoRecursionBinaryTreeTest {

    private NoRecursionBinaryTree<String, Integer> bt;

    public NoRecursionBinaryTreeTest() {
    }

    @Before
    public void beforeMethod() {
        bt = new NoRecursionBinaryTree<String, Integer>();
        bt.put("A", 2);
        bt.put("C", 1);
        bt.put("E", 6);
        bt.put("H", 2);
